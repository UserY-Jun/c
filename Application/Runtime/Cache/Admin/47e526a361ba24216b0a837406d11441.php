...
<form action="/index.php/Admin/Role/roleedit/role_id/2" method='post'>
 ...
 <br>
  ...
  <td> <?php echo str_repeat('&nbsp',$rows['lave']*30); ?><input  <?php  if(is_int(strpos($pri_id['pri_id'],$rows['id']))){ echo 'checked=checked'; } ?> lave='<?php echo $rows["lave"] ?>' type="checkbox" name='pri_id[]' value="<?php echo $rows['id'] ?>" class="checkbox"   > <?php echo $rows['pri_name'] ?>  </td>
