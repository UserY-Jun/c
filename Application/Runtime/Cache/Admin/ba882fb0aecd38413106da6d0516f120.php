 ...
 <script>
        //模糊搜索
          function Pagecookie(){
           ...
           //   alert(url);
              var url = "/index.php/Admin/Trade/tradeLIST";    
          ...
          function RecentDays_Jump(this_){
              var url = "/index.php/Admin/Trade/tradeLIST/p/9/OrderStateID/0.html";
              if(url.indexOf('.html')>0){
                 var url =  url.substring(0,url.indexOf('.html'));
              }
    ...
    function jump_link(){
        ...
        if(url.indexOf('?')>0 && url.indexOf('=')>0){
         ...
         function invoice_status_time_url(){
            ...
            location.href = "/index.php/Admin/Trade/tradeLIST/invoice_status_time/1";
...
<?php endforeach; ?>
    ...
    <ul>
        ...
        <input name="page" id="page" type="text" url="/index.php/Admin/Trade/tradeLIST/p/9/OrderStateID/0.html" value="<?php echo I('get.p')?(int)I('get.p'):''; ?>"><button type="sumbit" onclick="jump_link()">GO</button>
...
<div class="theme-popover">
     <div class="theme-poptit">
          <a href="javascript:;" title="关闭" class="close" onclick="close_()">×</a>
        
          <h2><span> 物流单号：<input id="tid"  name="tid" value="'+tid+'" type="hidden"/><br>&nbsp;&nbsp;</span></h2>  
     </div>
     <div class="theme-popbod dform">
           <form class="theme-signin" name="loginform" action="/index.php/Admin/Trade/AjaxeditOrder" method="post">
                <ol>
                    <li><strong style=" width: 330px; margin-left: -180px;">是否错发漏发：<span style=" background-color: red;cursor:pointer;" class="a_tishi"  ><input  name="wrong_replacement" value="1" class="Tooltip" type="checkbox" ></span></strong>
                         <br><br><br>
                        <strong style=" width: 330px;"> 
                           <!-- <input type="text" class="input-text"  value="" style="width:300px; height: 100px;"   placeholder="&nbsp;|-订单备注-|">    
                         <!--   <input type="button" name ="tid_s" style=" display:  none1;" value="5" id="tid_s">   -->
                           <textarea name="tid_s" id="tid_s" style=" display:  none;" ></textarea>
                           <textarea name="seller_memo" id="texar" style="width:300px; height: 100px; color: #999999;"   onclick="textarea_click()">订单备注</textarea>
                         </strong><br><br>
...
<script>
    texti = document.getElementById('texar');
    texinnet =    texti.innerHTML;
    function textarea_click(){
        if(texinnet=='订单备注'){   
             texti.innerHTML = '';               texti.style = "width:300px; height: 100px;";
        }
