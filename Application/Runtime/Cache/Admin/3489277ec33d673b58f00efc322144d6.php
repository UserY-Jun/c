...
<form action="" method="post"  enctype="multipart/form-data"  >
  ...
  <tr>
        ...
        <td style="PADDING:5px 10px; FONT-SIZE: 14px; line-height:20px; " bgcolor="#FFFFFF" align="left"><input name="style_name" id="Title" value="" size="30" class="input" type="text"></td>
  </tr>
