...
<table style="padding:0; margin:auto;" width="980" cellspacing="1" cellpadding="1" border="0" bgcolor="#E1E1E1" align="center">
   ...
   <tr>
       <td style="PADDING:5px 10px; FONT-SIZE: 14px; line-height:20px; " width="150" bgcolor="#FFFFFF" align="right" rowspan = " <?php $count=count($catlist)+1;echo $count; ?> ">分类名称：</td>
    </tr>   
    
    <?php foreach($catlist as $rows): ?> 
    <tr>
        <td style="PADDING:5px 10px; FONT-SIZE: 14px; line-height:20px; " bgcolor="#FFFFFF" align="left">
       <?php echo str_repeat('&nbsp',$rows['lave']*3).$rows['cat_name'] ?>
        </td>
