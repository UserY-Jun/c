...
<form action="" method="post"  enctype="multipart/form-data"  >
  ...
  <tr>
        <td style="PADDING:5px 10px; FONT-SIZE: 14px; line-height:20px; " width="150" bgcolor="#FFFFFF" align="right">分类名称：</td>
        <td style="PADDING:5px 10px; FONT-SIZE: 14px; line-height:20px; " bgcolor="#FFFFFF" align="left"><input name="cat_name" id="Title" value="" size="30" class="input" type="text"></td>
  </tr>

  <tr>
        <td style="PADDING:5px 10px; FONT-SIZE: 14px; line-height:20px; " bgcolor="#FFFFFF" align="right">所属分类：</td>
        <td style="PADDING:5px 10px; FONT-SIZE: 14px; line-height:20px; " bgcolor="#FFFFFF" align="left">
        
            <select name="parent_id">
     <option value="0">--顶级分类--</optopm>
     <?php foreach($catlist as $rows): ?>
     <option value="<?php echo $rows['id'] ?>"><?php echo str_repeat('&nbsp',$rows['lave']*3).$rows['cat_name'] ?></option>
     <?php endforeach; ?>
            </select>
 <br/>
