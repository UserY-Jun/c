...
<form action="" method="post"  enctype="multipart/form-data"  >
  ...
  <tr>
        <td style="PADDING:5px 10px; FONT-SIZE: 14px; line-height:20px; " width="150" bgcolor="#FFFFFF" align="right">风格名称：</td>
        <td style="PADDING:5px 10px; FONT-SIZE: 14px; line-height:20px; " bgcolor="#FFFFFF" align="left"><input name="style_name" id="Title" value="<?php echo $styleinfo[style_name] ?>" size="30" class="input" type="text"></td>
  </tr>

      <input type="hidden" name="id" value="<?php echo $styleinfo['id'] ?>"/>
