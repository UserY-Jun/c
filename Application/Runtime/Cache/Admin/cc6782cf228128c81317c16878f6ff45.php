...
<body rel="index">
		...
		<form action="../employee/index.asp?action=CheckLogin" method="post">
		<div style=" width:360px; height:50px;line-height:30px; text-align:left; font-size:14px; padding:20px; margin:0 auto;">
		<p style="margin-top:10px; font-size:16px; color:#666666; line-height:30px;" align="center">用户账号：&nbsp;<input name="mobile" id="mobile" value="" size="30" class="input" style="width:200px;" type="text"><input name="GoToUrl" id="GoToUrl" value="http://192.168.0.200/weight/main/index.asp" type="hidden"></p>
