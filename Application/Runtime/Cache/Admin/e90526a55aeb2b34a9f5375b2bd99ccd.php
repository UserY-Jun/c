...
<form method="post" action="" name="user" onsubmit="">
    <div class="list-div" id="listDiv">
        <table style="padding:0; margin:auto;" id="recordlist" width="980" cellspacing="0" cellpadding="0" border="0" bgcolor="#E1E1E1" align="center">
            ...
            <?php foreach($rolelist as $rows): ?>
            <tr align='center'>
                <td><?php echo $rows['id'] ?></td>
                <td ><?php echo $rows['role_name'] ?></td>
                
                <td ><?php echo $rows['pri_name'] ?></td>
            
            
              <td align="center">
                    <input type="button" value="修改" onclick="location.href='/index.php/Admin/Role/roleedit/role_id/<?php echo $rows[id] ?>'">
                    <input type="button" value="删除" onclick="location.href='/index.php/Admin/Role/roledel/role_id/<?php echo $rows[id] ?>'"> 
                </td>
            </tr>
            <?php endforeach; ?>
