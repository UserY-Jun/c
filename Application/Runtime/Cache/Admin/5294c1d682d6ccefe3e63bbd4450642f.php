...
<div style="width:980px; float:right; text-align:left; padding:0; font-size:14px; margin-top:20px;">
 ...
 <?php foreach($prilist as $rows): ?>
            <tr>
                ...
                <td align="center">
                    <input type="button" value="修改" onclick="location.href='/index.php/Admin/Privilege/priedit/pri_id/<?php echo $rows[id] ?>'">
                    <input type="button" value="删除" onclick="location.href='/index.php/Admin/Privilege/pridel/pri_id/<?php echo $rows[id] ?>'"> 
                </td>
            </tr>
            <br>
            <?php endforeach ?>
