...
<td class="" align="center"><font color="blue">
<?php  switch ($k['is_active']) { case 0: echo '<font color="bulue">锁定状态</font>'; break; case 1: echo '<font color="green">状态正常</font>'; break; case 2: echo '<font color="red">离职状态!</font>'; break; default: echo '<p>该用户状态出错</p>'; } ?>
    </font></td>
<td class="" align="center"><font color="#666666"><?php echo $k['is_iuqn']==1?'考勤':'不考勤' ?></font></td>
<td class="" valign="middle" align="center"><input name="button_33" class="btn sortnamecss" style="width:50px;" id="button_33" value="删除" onclick="location.href='/index.php/Admin/Admin/Admindel/id/<?php echo $k[id] ?>'" type="button">&nbsp;<input name="button_33" class="btn sortnamecss" style="width:50px;" id="button_33" value="恢复" onclick="location.href='/index.php/Admin/Admin/res/id/<?php echo $k[id] ?>'" type="button">&nbsp;<input name="button_33" class="btn sortnamecss" style="width:50px;" id="button_33" value="日志" onclick="AjaxLogList('33','1');" type="button"></td>
</tr>
