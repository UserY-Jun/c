    ...
    <div style="width:980px; float:right; text-align:left; padding:0; font-size:14px; margin-top:20px;">
		...
		<table style="padding:0; margin:auto;" id="recordlist" width="980" cellspacing="0" cellpadding="0" border="0" bgcolor="#E1E1E1" align="center">
			 <tbody><tr align="center" height="30">
               <td style="PADDING:5px 5px; FONT-SIZE: 14px; line-height:25px;" width="10%" bgcolor="#f7f7f7">风格名称</td>
...
<td style="height:40px;" class="" align="center">&nbsp;<?php echo $k['style_name'] ?>    &nbsp;</td>


<td class="" valign="middle" align="center"><input name="button_33" class="btn sortnamecss" style="width:50px;" id="button_33" value="删除" onclick="location.href='/index.php/Admin/Products/StyleDel/id/<?php echo $k[id] ?>'" type="button">&nbsp;<input name="button_33" class="btn sortnamecss" style="width:50px;" id="button_33" value="编辑" onclick="location.href='/index.php/Admin/Products/StyleEdit/id/<?php echo $k[id] ?>'" type="button">&nbsp;</td>
</tr>
