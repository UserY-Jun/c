...
class Model {
    ...
    public function save($data='',$options=array()) {
       ...
       if(false === $this->_before_update_get_options_data($data,$options)) {
           // return false;
        }
    ...
    protected  static $before_update_get_options_data;
    protected function _before_update_get_options_data($data,$options) { 
       if($options!=''){
                    $table_name=  str_replace(array('cms_'),'',$options['table']);  
                    $where=  $options['where']; 
                    $model=D($table_name);
                    $data=$model->where($where)->find();
           $this->$before_update_get_options_data=$data;   
       }
       return ($this->$before_update_get_options_data);   
    }
