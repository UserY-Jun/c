...
class Page{
     ...
     */
    public function __construct($totalRows, $listRows=20, $parameter = array(),$nPage) {
        ...
        if($_GET[$this->p]>  ceil($totalRows/$listRows)) {$this->nowPage = ceil($totalRows/$listRows);};//zdy
        if($nPage){$this->nowPage=$nPage;};//zdy
